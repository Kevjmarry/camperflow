...
export default function BookingsPage() {
  ...
  const getVehicleName = (booking: Booking) => {
    if (canManage) {
      return booking.vehicles?.name || <span style={{ color: 'rgb(var(--muted))' }}>Unassigned</span>;
    } else {
      return booking.vehicle_name || <span style={{ color: 'rgb(var(--muted))' }}>Unassigned</span>;
    }
  };
          ...
          {!loading && !error && bookings.length === 0 && (
            <div style={{ 
              ...
              <p style={{ marginBottom: 'var(--space-4)' }}>
                No bookings found.{canManage && ' Create your first booking to get started.'}
              </p>
              {canManage && (
                <Link 
                  href="/staff/bookings/new"
                    ...
                    >
                      ...
                      {canManage && (
                        <td style={{ padding: 'var(--space-3)' }}>
                          <div style={{ color: 'rgb(var(--text))' }}>{booking.customer_name || <span style={{ color: 'rgb(var(--muted))' }}>-</span>}</div>
                          <div style={{ fontSize: '13px', color: 'rgb(var(--muted))' }}>{booking.customer_phone || <span style={{ color: 'rgb(var(--muted))' }}>-</span>}</div>
                        </td>
                      )}
